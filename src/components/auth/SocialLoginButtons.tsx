...
export const SocialLoginButtons: React.FC<SocialLoginButtonsProps> = ({
  ...
  const { configuredProviders, isLoading, error, initiateLogin, clearError } = useOAuth();
    ...
    <div className={`space-y-3 ${className}`}>
      ...
      {configuredProviders.map((provider) => (
        <Button
          ...
          type="button"
          variant="outline"
          className={`w-full flex items-center justify-center gap-3 py-2.5 ${getProviderStyles(provider.id)}`}
